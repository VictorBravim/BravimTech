    ...
    return (
        <div className="bg-white px-6 lg:px-64 py-12 lg:py-24">
            ...
            <div className="flex flex-col lg:flex-row w-full gap-6 lg:gap-12">
                <div className="bg-white shadow-sm shadow-gray-400 p-2 rounded-xl lg:rounded-4xl flex flex-col items-center justify-between w-[100%] lg:w-[60%] h-72 lg:h-115">
                    <div className="relative w-full h-56 lg:h-96">
                        ...
                        <div className="absolute top-4 lg:top-8 left-4 lg:left-8 w-[80%] lg:w-[60%] text-white">
                            ...
                            <h3 className="text-xl lg:text-4xl font-bold mb-2 lg:mb-4">Desenvolvimento</h3>
                            <p className="text-xs lg:text-base leading-relaxed">
                                Somos especialistas em desenvolver sites modernos e responsivos de alta performance prontos para transformar a experiência da sua empresa
                            </p>
                        </div>
                    </div>
                ...
                <div className="bg-white shadow-sm shadow-gray-400 p-2 rounded-xl lg:rounded-4xl flex flex-col items-center justify-between w-[100%] lg:w-[40%] h-72 lg:h-115">
                    <div className="relative w-full h-56 lg:h-96">
                        ...
                        <div className="absolute top-4 lg:top-8 left-4 lg:left-8 w-[80%] lg:w-[70%] text-[#18181B]">
                            ...
                            <h3 className="text-xl lg:text-4xl font-bold mb-2 lg:mb-4">Design</h3>
                            <p className="text-xs lg:text-base leading-relaxed">
                ...
                <div className="bg-white shadow-sm shadow-gray-400 p-2 rounded-xl lg:rounded-4xl flex flex-col items-center justify-between w-[100%] lg:w-[40%] h-72 lg:h-115">
                    <div className="relative w-full h-56 lg:h-96">
                        ...
                        <div className="absolute top-4 lg:top-8 left-4 lg:left-8 w-[80%] lg:w-[70%] text-[#18181B]">
                            ...
                            <p className="text-xs lg:text-base leading-relaxed">
                                Deixe a tecnologia trabalhar ao seu favor, sem barreiras técnicas. Ideias simples, resultados impressionantes
                            </p>
                        </div>
                    </div>
                    <div className="bg-white/0 lg:p-4 rounded-lg w-full flex items-center justify-between">
